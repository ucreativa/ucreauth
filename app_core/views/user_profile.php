	...
	<div class="general_form_page">
		<div id="userpage">
		    ...
		    <fieldset id="gpb_profile" class="groupbox"> <legend>MI PERFIL</legend>
			    ...
			    <div class="block_form">
				    <?php echo cls_HTML::html_label_tag("Teléfono/Celular:"); ?>
				    <br />
		          ...
		          <br /><br />
				 	 <?php echo cls_HTML::html_label_tag("Descripción breve: (256 carac.)"); ?>
				    <br />
				    <?php echo cls_HTML::html_textarea(7,30,"txt_info","txt_info","textarea","",13,"","onkeypress='return max_Length(this,255,event);'","required"); ?>
				 </div>
			 </fieldset>
		   ...
		   /*Procedemos a llenar el formulario con los datos traídos del formulario
		    de búsqueda */
		  	...
		  	if(isset($_GET['edit']) && isset($_GET['id'])){
		  	   ...
		  	   if(isset($_GET['chprof']) && !(isset($_POST['btn_save']))){
		  	      if($_GET['chprof']==1){
		  	   	  	echo "<script>
				  	   	  	  $(document).ready(function() {
					  	           $('#chk_editprofile').click();
					  	           enable_edit(document.getElementById('chk_editprofile'));
					  	        });
			  	           </script>";
		  	         cls_Message::show_message("Por favor actualice sus datos de perfil.","info","");
		  	      }
		  	   }
